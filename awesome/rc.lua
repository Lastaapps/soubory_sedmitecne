...
globalkeys = gears.table.join(
    ...
    -- awful.key({ "Shift" }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer -D pulse sset Master 10%+", false) end),
    -- awful.key({ "Shift" }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer -D pulse sset Master 10%-", false) end),
